const apiUrl = "http://10.10.24.239:9501"
const websocketUrl = "ws://10.10.24.239:9502";
...
const gameConfig = {
    chess: {
        ...
        imgs: [
            {
                src: "/static/images/website/chess_t.jpg",
                path: "/chinessChess"
            },
            {
                src: "/static/images/website/wuzi_t.jpg",
                path: "/lineFive",
            }
        ],
        list: [
            {
                ...
                code: "ChineseChess",
                path: "/chinessChess",
                img: "/static/images/website/chess_t.jpg",
            ...
            },
            {
                ...
                code: "LineFive",
                path: "/lineFive",
                img: "/static/images/website/wuzi_t.jpg",
    ...
    pocker: {
        ...
        imgs: [
            {
                src: "/static/images/website/dizhu_t.jpg",
                path: "/dizhu"
            },
            {
                src: "/static/images/website/blackjack_t.jpg",
                path: "/blackJack",
            }
        ],
        list: [
            {
                ...
                code: "Dizhu",
                path: "/dizhu",
                img: "/static/images/website/dizhu_t.jpg",
            ...
            },
            {
                ...
                code: "BlackJack",
                path: "/blackJack",
                img: "/static/images/website/blackjack_t_2.jpg",
    ...
    casual: {
        ...
        imgs: [
            {
                src: "/static/images/website/snack_t.jpg",
                path: "/snack"
            }
        ],
        list: [
            {
                ...
                code: "Snack",
                path: "/snack",
                img: "/static/images/website/snack_t.jpg",
